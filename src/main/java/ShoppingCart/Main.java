...
import ShoppingCart.Models.Item;
import ShoppingCart.Models.Store;
...
public class Main {
    ...
    public static final String RELATIVE_PATH = "/Users/nsovi/Desktop/JavaProjects/UdemyCorse/src/main/java/ShoppingCart/products.txt";
    static Cart cart = new Cart();
    public static void main(String[] args) {
        try {
            loadItems(RELATIVE_PATH);
            manageItems();
